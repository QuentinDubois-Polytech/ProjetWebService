...
namespace ApplicationServerConsole
{
    internal class Program
    {
        static void Main(string[] args) {
            ...
            //ApplicationService appli = new ApplicationService();
            //ClientOpenStreetMapAPI api = new ClientOpenStreetMapAPI();

            //Console.WriteLine(JsonSerializer.Serialize(appli.GetItinerary("Paris", "Lyon")));
